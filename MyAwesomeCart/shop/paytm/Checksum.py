...
def verify_checksum(param_dict, merchant_key):
    # Remove checksum
    # if 'CHECKSUMHASH' in param_dict:
    # param_dict.pop('CHECKSUMHASH')

    # Get salt
    # paytm_hash = __decode__(IV, merchant_key)
    # salt = paytm_hash[-4:]
    checksum = generate_checksum(param_dict, merchant_key, salt=None)
    print("calculated_checksum", checksum)
    return checksum


def verify_checksum_by_str(param_str, merchant_key):
    # Remove checksum
    # if 'CHECKSUMHASH' in param_dict:
    # param_dict.pop('CHECKSUMHASH')
